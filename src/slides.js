!(function () {
  ...
  function X(e) {
    ...
    for (
      ...
      void 0 !== p[e + t]
        ? h >= p[e] && h < p[e + t] && ((f = e), (g = p[e + t] - p[e]))
        : h >= p[e] && ((f = e), (g = p[p.length - 1] - p[p.length - 2]));
    }
    let v = null,
      w = null;
    r.rewind &&
